...
extension Notification.Name {
    ...
    static let settingsDidChangeViaURI = Notification.Name("com.xera.xmenubar.settingsDidChangeViaURI")

    /// Posted when a per-display setting is changed externally via Settings URI scheme.
    static let perDisplaySettingsDidChangeViaURI = Notification.Name("com.xera.xmenubar.perDisplaySettingsDidChangeViaURI")

    /// Posted when a get request response is broadcast via distributed notification.
    static let settingsURIGetResponse = Notification.Name("com.xera.xmenubar.settingsURIGetResponse")

    /// Posted when the Settings URI whitelist changes.
    static let settingsURIWhitelistDidChange = Notification.Name("com.xera.xmenubar.settingsURIWhitelistDidChange")
}
