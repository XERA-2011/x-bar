...
enum HookRunner {
    ...
    static func run(
        ...
        let environment = Environment.inherit.updating([
            "XMENUBAR_HOOK_PHASE": context.phase.rawValue.capitalized,
            "XMENUBAR_HOOK_SCOPE": context.scope.rawValue.capitalized,
            "XMENUBAR_PROFILE_ID": context.profileID.uuidString,
            "XMENUBAR_PROFILE_NAME": context.profileName,
            "XMENUBAR_PREVIOUS_PROFILE_ID": context.previousProfileID?.uuidString ?? "",
            "XMENUBAR_PREVIOUS_PROFILE_NAME": context.previousProfileName ?? "",
        ])
        ...
        // XMenuBar's own process group, and a group-targeted signal would be
        // delivered to XMenuBar as well.
        //
