...
nonisolated enum SearchIndex {
    ...
    private static let paneEntries: [SearchEntry] = [
        ...
        SearchEntry(
            ...
            sectionKey: nil,
            sectionText: nil,
            keywords: ["display", "monitor", "screen", "notch", "spacing", "ice bar", "xmenubar bar", "arrangement"],
            property: nil
        ),
        SearchEntry(
    ...
    private static let generalEntries: [SearchEntry] = [
        ...
        SearchEntry(
            ...
            sectionKey: "Global",
            sectionText: "Global",
            keywords: ["ice bar", "xmenubar bar", "mouse", "pointer", "hotkey", "location"],
    ...
    private static let advancedEntries: [SearchEntry] = [
        ...
        SearchEntry(
            id: "advanced.useXMenuBarBarOnNotchOverflow",
            titleKey: "Use the XMenuBar Bar while items are overflowed",
            titleText: "Use the XMenuBar Bar while items are overflowed",
            descriptionText: "Reveal hidden items through the XMenuBar Bar while notch overflow has items ejected, since the visible row has no room left to expand into.",
            pane: .menuBarLayout,
            sectionKey: "Advanced layout controls",
            sectionText: "Advanced layout controls",
            keywords: ["overflow", "notch", "xmenubar bar", "ice bar", "hidden", "reveal"],
            property: .advanced("useXMenuBarBarOnNotchOverflow")
        ),
        SearchEntry(
    ...
    private static let displayEntries: [SearchEntry] = [
        SearchEntry(
            ...
            sectionKey: "Global",
            sectionText: "Global",
            keywords: ["ice bar", "xmenubar bar", "hidden", "separate bar"],
            property: nil
        ),
        SearchEntry(
            id: "displays.useXMenuBarBarForAlwaysHidden",
            ...
            sectionKey: "Global",
            sectionText: "Global",
            keywords: ["ice bar", "xmenubar bar", "always-hidden", "always hidden", "only"],
            property: nil
        ),
        SearchEntry(
        ...
        SearchEntry(
            ...
            sectionKey: "Global",
            sectionText: "Global",
            keywords: ["ice bar", "xmenubar bar", "location", "mouse", "aligned"],
            property: nil
        ),
        SearchEntry(
            ...
            sectionKey: "Global",
            sectionText: "Global",
            keywords: ["ice bar", "xmenubar bar", "layout", "arrangement", "horizontal", "vertical", "grid", "columns"],
            property: nil
        ),
        SearchEntry(
    ...
    private static let hotkeyEntries: [SearchEntry] = [
        ...
        SearchEntry(
            ...
            sectionKey: "Other",
            sectionText: "Other",
            keywords: ["enable", "ice bar", "xmenubar bar", "hotkey", "shortcut"],
            property: nil
        ),
        SearchEntry(
