...
/// Read-side view of the Focus mode requested by ``XMenuBarFocusFilter``.
///
/// Profile-specific Focus Filter triggers need the requested XMenuBar profile by
...
nonisolated enum XMenuBarFocusModeStore {
    /// The active Focus Filter's requested XMenuBar profile name, or
    /// `nil` when no XMenuBar Focus Filter is currently applied.
    ...
    static var manifestURL: URL? {
        FileManager.default
            ...
            .first?
            .appendingPathComponent("XMenuBar/Profiles/profiles.json")
    }
