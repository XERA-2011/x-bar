...
extension DisplaySettingsManager {
    ...
    private func presentSpacingRelaunchConfirmation() -> Bool {
        ...
        alert.informativeText = String(localized: "When a display transition requires XMenuBar to apply a different menu bar spacing, XMenuBar relaunches apps with menu bar items. Relaunching apps may cause unsaved input, progress, or transient app state to be lost.")
