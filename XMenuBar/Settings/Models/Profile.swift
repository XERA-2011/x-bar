...
nonisolated struct AdvancedSettingsSnapshot: Codable {
    ...
    var useXMenuBarBarOnNotchOverflow: Bool
    ...
    static func capture(from settings: AdvancedSettings) -> AdvancedSettingsSnapshot {
        AdvancedSettingsSnapshot(
            ...
            useXMenuBarBarOnNotchOverflow: settings.useXMenuBarBarOnNotchOverflow,
    ...
    func apply(to settings: AdvancedSettings) {
        ...
        settings.useXMenuBarBarOnNotchOverflow = useXMenuBarBarOnNotchOverflow
    ...
    init(
        ...
        useXMenuBarBarOnNotchOverflow: Bool = Defaults.DefaultValue.useXMenuBarBarOnNotchOverflow,
        ...
        self.useXMenuBarBarOnNotchOverflow = useXMenuBarBarOnNotchOverflow
    ...
    init(from decoder: Decoder) throws {
        ...
        useXMenuBarBarOnNotchOverflow = try container.decodeIfPresent(
            Bool.self, forKey: .useXMenuBarBarOnNotchOverflow
        ) ?? Defaults.DefaultValue.useXMenuBarBarOnNotchOverflow
...
nonisolated struct Profile: Codable, Identifiable {
    ...
    init(from decoder: Decoder) throws {
        ...
        advancedSettings = try container.decodeIfPresent(
            ...
            useXMenuBarBarOnNotchOverflow: Defaults.DefaultValue.useXMenuBarBarOnNotchOverflow,
