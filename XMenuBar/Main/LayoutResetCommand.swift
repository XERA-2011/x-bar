...
/// Settings. #899's reporter had to kill XMenuBar from a terminal; this lets
/// them repair the bar from the same terminal, before starting it again:
///
///     /Applications/XMenuBar.app/Contents/MacOS/XMenuBar --reset-layout
///
...
enum LayoutResetCommand {
    ...
    static func runIfRequested(arguments: [String] = CommandLine.arguments) -> Bool {
        ...
        print("XMenuBar: menu bar layout reset. Start XMenuBar again to rebuild it.")
        return true
    }
}
