...
extension MenuBarItemManager {
    ...
    enum EventError: CustomStringConvertible, LocalizedError {
        ...
        var recoverySuggestion: String? {
            ...
            case let .dropReverted(item):
                ...
                // item in the field. Say so, or the alert reads as a XMenuBar
    ...
    nonisolated func waitForUserToPauseInput(
        ...
        //   defaults write com.xera.xmenubar inputPauseThresholdMs -int <milliseconds>
    ...
    ///   defaults write com.xera.xmenubar bulkApplyIdleThresholdMs -int 0
