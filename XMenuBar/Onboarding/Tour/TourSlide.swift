...
nonisolated enum XMenuBarTourSlide: Int, CaseIterable, Identifiable {
    ...
    var description: String {
        switch self {
        case .welcome:
            String(localized: "XMenuBar gives you complete control over your menu bar — hide clutter, customize the look, and automate your workflow.")
        case .menuBarManagement:
        ...
        case .hotkeysAutomation:
            String(localized: "Trigger any action with a keystroke. Combine auto-rehide timers and Focus Filter integration so XMenuBar adapts to whatever you're doing.")
        case .profiles:
            String(localized: "Save your current configuration as a named profile. Switch between layouts instantly, or let XMenuBar switch automatically when you change your frontmost app.")
        }
    }
