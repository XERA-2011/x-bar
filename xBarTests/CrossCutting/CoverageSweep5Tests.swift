...
struct CoverageSweep5Tests {
    ...
    struct DispatchQueueTests {
        ...
        func targetingGlobalKeepsItsLabel() {
            let queue = DispatchQueue.targetingGlobal(label: "com.xera.xmenubarTests.sweep")

            #expect(queue.label == "com.xera.xmenubarTests.sweep")
        ...
        func targetingGlobalAcceptsQoSAndAttributes() {
            let queue = DispatchQueue.targetingGlobal(
                label: "com.xera.xmenubarTests.sweep.concurrent",
                qos: .utility,
            ...
            #expect(queue.label == "com.xera.xmenubarTests.sweep.concurrent")
            #expect(total == 2)
        }
    }
