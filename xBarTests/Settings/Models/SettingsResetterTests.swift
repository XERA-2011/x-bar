...
struct SettingsResetterTests {
    ...
    func resetAdvancedRestoresEveryBoolean() throws {
        try withSettings { settings in
            ...
            settings.advanced.useXMenuBarBarOnNotchOverflow = !Defaults.DefaultValue.useXMenuBarBarOnNotchOverflow
            ...
            #expect(settings.advanced.useXMenuBarBarOnNotchOverflow == Defaults.DefaultValue.useXMenuBarBarOnNotchOverflow)
