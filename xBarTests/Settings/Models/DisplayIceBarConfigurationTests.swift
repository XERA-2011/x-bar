...
struct DisplayIceBarConfigurationTests {
    ...
    func defaultConfiguration() {
        ...
        #expect(!config.useXMenuBarBarForAlwaysHidden)
    ...
    @Test("withUseXMenuBarBarForAlwaysHidden changes only the always-hidden flag")
    func withUseXMenuBarBarForAlwaysHidden() {
        let original = DisplayIceBarConfiguration.defaultConfiguration
        let modified = original.withUseXMenuBarBarForAlwaysHidden(true)

        #expect(modified.useXMenuBarBarForAlwaysHidden)
    ...
    @Test("withUseXMenuBarBarForAlwaysHidden leaves the original alone")
    func withUseXMenuBarBarForAlwaysHiddenDoesNotMutateOriginal() {
        let original = DisplayIceBarConfiguration.defaultConfiguration
        _ = original.withUseXMenuBarBarForAlwaysHidden(true)

        #expect(!original.useXMenuBarBarForAlwaysHidden)
    }
    ...
    func otherWithMethodsPreserveUseXMenuBarBarForAlwaysHidden() {
        let original = DisplayIceBarConfiguration.defaultConfiguration
            .withUseXMenuBarBarForAlwaysHidden(true)

        #expect(original.withUseIceBar(true).useXMenuBarBarForAlwaysHidden)
        #expect(original.withIceBarLocation(.iceIcon).useXMenuBarBarForAlwaysHidden)
        #expect(original.withAlwaysShowHiddenItems(true).useXMenuBarBarForAlwaysHidden)
        #expect(original.withIceBarLayout(.grid).useXMenuBarBarForAlwaysHidden)
        #expect(original.withGridColumns(6).useXMenuBarBarForAlwaysHidden)
        #expect(original.withItemSpacingOffset(4).useXMenuBarBarForAlwaysHidden)
    }
    ...
    func equatableDifferentUseXMenuBarBarForAlwaysHidden() {
        let config1 = DisplayIceBarConfiguration.defaultConfiguration
        let config2 = config1.withUseXMenuBarBarForAlwaysHidden(true)
    ...
    func encodeDecode() throws {
        let original = DisplayIceBarConfiguration(
            useIceBar: true,
            useXMenuBarBarForAlwaysHidden: true,
    ...
    func decodeFromJSON() throws {
        ...
        #expect(decoded.useXMenuBarBarForAlwaysHidden)
