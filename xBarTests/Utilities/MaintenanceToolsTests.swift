...
struct MaintenanceToolsTests {
    ...
    func cacheDirectoryNamesIncludeTheLegacyName() {
        ...
        #expect(names == ["com.example.app", "com.xera.xmenubar"])
    }

    @Test("A bundle id equal to the legacy name is not listed twice")
    func cacheDirectoryNamesDeduplicate() {
        let names = MaintenanceTools.appCacheDirectoryNames(bundleIdentifier: "com.xera.xmenubar")
        #expect(names == ["com.xera.xmenubar"])
    }
    ...
    func clearAppCacheRemovesBothDirectories() throws {
        ...
        let legacy = root.appending(path: "com.xera.xmenubar", directoryHint: .isDirectory)
