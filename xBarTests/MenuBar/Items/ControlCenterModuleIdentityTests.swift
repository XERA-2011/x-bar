...
struct ControlCenterModuleIdentityTests {
    ...
    /// XMenuBar's own control items never carry a module title, and neither do
    ...
    func controlItemsAndSpacersAreNotMisattributed() {
        ...
        #expect(!tag(namespace: "com.xera.xmenubar", title: "Spacer.1234.autosaveName")
            .isMisattributedControlCenterModule)
    }
    ...
    /// the exact wrong-side deletion #927 fixed for XMenuBar's own namespace.
