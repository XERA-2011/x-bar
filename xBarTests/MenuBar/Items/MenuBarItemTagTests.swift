...
struct MenuBarItemTagTests {
    ...
    struct NamespaceTests {
        ...
        @Test("The XMenuBar namespace is XMenuBar's bundle identifier")
        func xmenubarNamespace() {
            let xmenubar = MenuBarItemTag.Namespace.xmenubar
            #expect(xmenubar.isString)
            #expect(xmenubar.description == Constants.bundleIdentifier)
        }
    ...
    struct TagTests {
        ...
        @Test("A XMenuBar item is a system item")
        func isSystemItemForXMenuBar() {
            let tag = MenuBarItemTag(
                namespace: .xmenubar,
                title: "SomeItem"
            )
