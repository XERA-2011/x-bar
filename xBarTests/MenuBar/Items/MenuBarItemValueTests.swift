...
struct MenuBarItemValueTests {
    ...
    struct CapabilityFlags {
        ...
        func genericControlCenterSlotFlipsWithSourceResolution() {
            ...
            // times out, but nothing stops XMenuBar from hiding it.
        ...
        func spacerIsAControlItem() {
            let item = MenuBarItem.fixture(tag: appTag("XMenuBar.Spacer.1"), windowID: 20, sourcePID: nil)
    ...
    struct AutoDetectedName {
        ...
        func spacerShortCircuits() {
            let item = MenuBarItem.fixture(tag: appTag("XMenuBar.Spacer.1"), windowID: 31, sourcePID: testRunnerPID)
