...
struct PlanNotchOverflowTests {
    ...
    private let chevron = "xmenubar:VisibleControlItem"
    private let hiddenCtrl = "xmenubar:HiddenControlItem"
    private let ahCtrl = "xmenubar:AlwaysHiddenControlItem"
    ...
    /// XMenuBar icon near the end of the visible section (items after it), not at
