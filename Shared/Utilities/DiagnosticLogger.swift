...
///
/// Log files are written to `~/Library/Logs/XMenuBar/`.
final nonisolated class DiagnosticLogger: @unchecked Sendable {
    ...
    var logDirectory: URL {
        ...
        return home
            ...
            .appendingPathComponent("XMenuBar", isDirectory: true)
    }
    ...
    private let osLog = Logger(
        subsystem: Bundle.main.bundleIdentifier ?? "com.xera.xmenubar",
    ...
    private let writeQueue = DispatchQueue(
        label: "com.xera.xmenubar.DiagnosticLogger.writeQueue",
        qos: .utility
    )
    ...
    private func openLogFile() {
        ...
        let baseName = "xmenubar_\(fileNameFormatter.string(from: Date()))"
