...
///   It matters because a `xmenubar://` URL carrying `display=` with nothing after
...
/// so the suite never touches the developer's real `com.xera.xmenubar` domain —
...
struct SettingsURIHandlerTailTests {
    ...
    struct EmptyDisplayIdentifier {
        ...
        @Test(
            ...
            arguments: ["useIceBar", "alwaysShowHiddenItems", "useXMenuBarBarForAlwaysHidden", "iceBarLocation", "iceBarLayout", "gridColumns"]
        )
        func emptyDisplayIdentifierFallsBackToTheDefaultScopeOnSet(_ key: String) throws {
            ...
            case "alwaysShowHiddenItems", "useXMenuBarBarForAlwaysHidden": "allNonIceBar"
            default: "allEnabled"
            }
        ...
        @Test(
            ...
            arguments: [
                ...
                ("useXMenuBarBarForAlwaysHidden", "allNonIceBar"),
            ]
        )
