...
///
/// Parses real XMenuBar log lines into per-cycle records and drives the actual
...
/// shape XMenuBar observed on this cycle, did the planner deem the right items
...
struct ProfileLayoutLogReplayTests {
    ...
    /// recorded. If a control item's namespace or title changes in the XMenuBar
    ...
    func loggedDesiredVisibleIsUsedInsteadOfInference() throws {
        let log = """
        2026-05-30 09:00:00.000 [DEBUG] [MenuBarItemManager] applyProfileLayout: current visible section has 3 items: ["com.xera.xmenubar:XMenuBar.ControlItem.Visible", "com.example.extra:Item-0", "com.rogueamoeba.soundsource:SSMainAppMenuIcon"]
        ...
        2026-05-30 09:00:00.004 [DEBUG] [MenuBarItemManager] Profile layout Phase 1: ahCtrlUID=com.xera.xmenubar:XMenuBar.ControlItem.AlwaysHidden, crossSectionMoves=0, totalSectionMismatch=0
    ...
    /// Replays a real field cycle (xmenubar_2026-06-07_09-48-52.log, 11:44:42)
    ...
    func displayReconnectNegativeBudgetYieldsNoOverflow() throws {
        let log = """
        2026-06-07 11:44:42.027 [DEBUG] [MenuBarItemManager] applyProfileLayout: current visible section has 4 items: ["leits.MeetingBar:Item-0", "eu.exelban.Stats:CPU_bar_chart", "com.xera.xmenubar:XMenuBar.ControlItem.Visible", "com.apple.TextInputMenuAgent:Item-0"]
    ...
    /// Replays a real field cycle (xmenubar_2026-06-11_09-11-10.log, 11:31:05) on
    ...
    /// that stale geometry and moved the XMenuBar visible icon to the far left. The
    ...
    /// Replays a real field cycle (xmenubar_2026-08-20_11-21-26.log, 16:32:47.8,
    ...
    func overflowEjectedFieldCycleIsNotABoundaryOffender() throws {
        let log = """
        2026-08-20 16:32:47.824 [DEBUG] [MenuBarItemManager] applyProfileLayout: current visible section has 12 items: ["com.steipete.codexbar:codexbar-codex", "com.steipete.codexbar:codexbar-claude", "com.tunabellysoftware.tgpro:Item-0", "eu.exelban.Stats:CPU_bar_chart", "eu.exelban.Stats:GPU_bar_chart", "eu.exelban.Stats:RAM_bar_chart", "com.rogueamoeba.soundsource:SSMainAppMenuIcon", "com.rogueamoeba.soundsource:Input", "com.apphousekitchen.aldente-pro:Item-0", "com.xera.xmenubar:XMenuBar.ControlItem.Visible", "org.p0deje.Maccy:Item-0", "com.apple.TextInputMenuAgent:Item-0"]
        ...
        2026-08-20 16:32:47.828 [DEBUG] [MenuBarItemManager] Profile layout Phase 1: ahCtrlUID=com.xera.xmenubar:XMenuBar.ControlItem.AlwaysHidden, crossSectionMoves=0, totalSectionMismatch=0
        ...
        let liveControlUIDs: Set = ["com.xera.xmenubar:XMenuBar.ControlItem.Visible",
                                    "com.xera.xmenubar:XMenuBar.ControlItem.AlwaysHidden"]
...
/// Parses XMenuBar profile-layout log text into replayable cycles and drives the
...
enum ProfileLayoutLogReplay {
    ...
    private static let visibleCtrlUID = "com.xera.xmenubar:XMenuBar.ControlItem.Visible"
    private static let hiddenCtrlUID = "com.xera.xmenubar:XMenuBar.ControlItem.Hidden"
    ...
    ///
    ///     grep -rn 'Format contract: parsed by ProfileLayoutLogReplayTests' XMenuBar/
    ///
...
extension ProfileLayoutLogReplay.Cycle {
    ...
    func partitionInputs(unresolvedSourcePIDBaseUIDs: Set<String>) -> ProfileLayoutLogReplay.PartitionInputs {
        ...
        // derived from them through live XMenuBar code (uniqueIdentifier,
...
/// (e.g. an in-app update) XMenuBar must arm a settling period so the move pass
