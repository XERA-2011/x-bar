...
struct ProfileSnapshotLiveSettingsTests {
    ...
    func captureAdvancedSettings() throws {
        try withScratchDefaults { _ in
            ...
            settings.useXMenuBarBarOnNotchOverflow = false
            ...
            #expect(snapshot.useXMenuBarBarOnNotchOverflow == false)
    ...
    func applyAdvancedSettings() throws {
        try withScratchDefaults { _ in
            ...
            let snapshot = AdvancedSettingsSnapshot(
                ...
                useXMenuBarBarOnNotchOverflow: false,
            ...
            #expect(settings.useXMenuBarBarOnNotchOverflow == false)
    ...
    func captureEncodeDecodeApplyAdvancedRoundTrip() throws {
        try withScratchDefaults { _ in
            ...
            source.useXMenuBarBarOnNotchOverflow = false
            ...
            #expect(destination.useXMenuBarBarOnNotchOverflow == source.useXMenuBarBarOnNotchOverflow)
