...
struct MenuBarSectionNameTests {
    ...
    @Test("Items that do not fit fall back to the XMenuBar Bar when hiding menus is disabled")
    ...
    @Test("Application menus are hidden before falling back to the XMenuBar Bar")
    ...
    @Test("Items that cannot fit even without the application menus use the XMenuBar Bar")
