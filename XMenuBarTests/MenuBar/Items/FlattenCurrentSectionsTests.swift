...
struct FlattenCurrentSectionsTests {
    private let hiddenCtrl = "com.xera.xmenubar:XMenuBar.ControlItem.Hidden"
    private let ahCtrl = "com.xera.xmenubar:XMenuBar.ControlItem.AlwaysHidden"
    ...
    func orderWithAlwaysHiddenPresent() {
        let visibleCtrl = "com.xera.xmenubar:XMenuBar.ControlItem.Visible"
