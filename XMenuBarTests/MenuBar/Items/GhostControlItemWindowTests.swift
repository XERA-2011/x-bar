...
struct GhostControlItemWindowTests {
    private let hiddenTitle = "XMenuBar.ControlItem.Hidden"
    private let alwaysHiddenTitle = "XMenuBar.ControlItem.AlwaysHidden"
    private let visibleTitle = "XMenuBar.ControlItem.Visible"
    ...
    func controlItemPairPrefersAuthoritativeWindowIDs() {
        var items = [
            ...
            item(
                tag: .appItem(bundleID: "com.xera.xmenubar", title: hiddenTitle, instanceIndex: 1),
                windowID: 21542,
                title: hiddenTitle
            ),
            item(
                tag: .appItem(bundleID: "com.xera.xmenubar", title: alwaysHiddenTitle, instanceIndex: 1),
                windowID: 21543,
    ...
    /// The window Control Center kept serving after the XMenuBar process behind
    ...
    private var orphan: MenuBarItem {
        item(
            tag: .appItem(bundleID: "com.xera.xmenubar", title: "com.xera.xmenubar"),
            windowID: 639,
            title: "com.xera.xmenubar"
        )
    }
    ...
    func orphanDetectionKeepsUserSpacers() {
        ...
        let items = [
            item(tag: .hiddenControlItem, windowID: 16233, title: hiddenTitle),
            item(
                tag: .appItem(bundleID: "com.xera.xmenubar", title: spacerTitle),
                windowID: 17001,
                title: spacerTitle
            ),
        ]
