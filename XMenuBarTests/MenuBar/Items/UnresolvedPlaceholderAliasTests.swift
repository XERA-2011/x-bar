...
///
/// Only the pure halves (`appBundleID(from:excluding:xmenubarBundleID:)` and
...
struct UnresolvedPlaceholderAliasTests {
    ...
    private static let xmenubarBundleID = "com.xera.xmenubar"
    ...
    func appBundleIDPrefersAXIdentifier() {
        ...
        let bundleID = UnresolvedPlaceholderAlias.appBundleID(
            ...
            xmenubarBundleID: Self.xmenubarBundleID
        )
    ...
    @Test("appBundleID rejects XMenuBar's own bundle identifier")
    func appBundleIDRejectsXMenuBar() {
        let identity = AXIdentityCatalog.AXItemIdentity(
            identifier: Self.xmenubarBundleID,
            title: nil,
            help: nil,
            frame: .zero
        )
