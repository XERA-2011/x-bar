...
///
/// Pins down two invariants the field-reported "XMenuBar icon keeps moving"
/// regression turned out to depend on:
///
/// 1. All three XMenuBar control items (hidden, alwaysHidden, visible) are
...
struct PartitionUnmanagedUIDsTests {
    ...
    func allThreeControlItemsExcluded() {
        let hidden = "com.xera.xmenubar:XMenuBar.ControlItem.Hidden"
        let ah = "com.xera.xmenubar:XMenuBar.ControlItem.AlwaysHidden"
        let visible = "com.xera.xmenubar:XMenuBar.ControlItem.Visible"
