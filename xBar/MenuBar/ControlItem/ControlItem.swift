...
final class ControlItem {
    ...
    nonisolated enum Identifier: String, CaseIterable {
        ...
        case visible = "xBar.ControlItem.Visible"
        /// The identifier for the control item for the hidden section.
        case hidden = "xBar.ControlItem.Hidden"
        /// The identifier for the control item for the always-hidden section.
        case alwaysHidden = "xBar.ControlItem.AlwaysHidden"

        init?(rawValue: String) {
            switch rawValue {
            case "xBar.ControlItem.Visible", "XMenuBar.ControlItem.Visible":
                self = .visible
            case "xBar.ControlItem.Hidden", "XMenuBar.ControlItem.Hidden":
                self = .hidden
            case "xBar.ControlItem.AlwaysHidden", "XMenuBar.ControlItem.AlwaysHidden":
                self = .alwaysHidden
            default:
                return nil
            }
        ...
        static func isControlItemTitle(_ title: String) -> Bool {
            title.hasPrefix("xBar.ControlItem.") || title.hasPrefix("XMenuBar.ControlItem.")
        }
...
nonisolated enum ControlItemDefaults {
    ...
    /// only ever blocked XMenuBar's own writes — including the seeding that
    ...
    static func isSectionDivider(autosaveName: String) -> Bool {
        autosaveName == ControlItem.Identifier.hidden.rawValue ||
            ...
            autosaveName == "XMenuBar.ControlItem.Hidden" ||
            autosaveName == "XMenuBar.ControlItem.AlwaysHidden"
    }
