...
class LayoutBarArrangedView: NSView {
    ...
    /// Intermediate rows may xmenubar as soon as the pointer exits, but the
    ...
    /// xmenubar and reconcile it underneath the newer drag.
...
extension LayoutBarArrangedView: NSDraggingSource {
    ...
    func draggingSession(_: NSDraggingSession, endedAt _: NSPoint, operation: NSDragOperation) {
        ...
        // task. Transfer the original view back before xmenubaring either row;
