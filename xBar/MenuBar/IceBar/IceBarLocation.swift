...
/// Locations where the XMenuBar Bar can appear.
nonisolated enum IceBarLocation: Int, CaseIterable, Codable, Identifiable {
    /// The XMenuBar Bar will appear in different locations based on context.
    case dynamic = 0

    /// The XMenuBar Bar will appear centered below the mouse pointer.
    case mousePointer = 1

    /// The XMenuBar Bar will appear centered below the Ice icon.
    case iceIcon = 2

    /// The XMenuBar Bar will appear aligned to the left edge of the display.
    case leftAligned = 3

    /// The XMenuBar Bar will appear aligned to the right edge of the display.
    case rightAligned = 4
