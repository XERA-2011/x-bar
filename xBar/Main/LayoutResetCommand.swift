...
/// Settings. #899's reporter had to kill xBar from a terminal; this lets
/// them repair the bar from the same terminal, before starting it again:
///
///     /Applications/xBar.app/Contents/MacOS/xBar --reset-layout
///
...
enum LayoutResetCommand {
    ...
    static func runIfRequested(arguments: [String] = CommandLine.arguments) -> Bool {
        ...
        print("xBar: menu bar layout reset. Start xBar again to rebuild it.")
        return true
    }
}
