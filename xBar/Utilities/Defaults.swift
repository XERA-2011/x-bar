...
nonisolated extension Defaults {
    enum DefaultValue {
        ...
        static let operationMode: OperationMode = .inline
...
nonisolated extension Defaults {
    enum Key: String {
        ...
        /// instead of a live capture, everywhere XMenuBar renders them.
        ...
        /// of points off-screen, which the XMenuBar Bar renders from the cache
        ...
        /// Whether XMenuBar rearranges the bar on its own initiative.
        ///
        ...
        /// every status item window, so the CG owner of the window XMenuBar is
        /// dragging is Control Center, while `sourcePID` names the app whose
        /// status item it logically is. XMenuBar has always preferred
